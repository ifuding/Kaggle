...
python3 main.py --model_type l --full_connect_hn 32 --stacking False --nfold 5 \
        --batch_size 1024 --full_connect_dropout 0 \
        --epochs 4 --ensemble_nfold 1 --batch_interval 20000 \
        --input-training-data-path ../Data/FullCnt/ --output-model-path ../Data/ --emb_dim "5,5,5,5,5,5,4" \
        --debug False --neg_sample False --sample_C 5 --load_only_singleCnt True
