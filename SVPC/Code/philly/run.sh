...
python3 $1.py --model_type k --full_connect_hn 64,32 --stacking False --nfold 5 \
        --batch_size 16 --full_connect_dropout 0.2 \
        --epochs 15 --ensemble_nfold 5 --batch_interval 20000 \
        ...
        --load_from_vae False --rnn_units 40 --predict_feature False
