...
python3 PoolGRU.py --input-training-data-path ../../Data/ --output-model-path . --model_type l \
        --max_seq_len 100 --nfold 2 --emb_dim 300 --epochs 1 --batch_size 64 --ensemble_nfold 2 \
        --filter_size 100 --batch_interval 1000000 --full_connect_dropout 0 --emb_dropout 0 \
        --full_connect_hn 2 --rnn_unit 0 --vocab_size 150000 --separate_label_layer False --stem False \
