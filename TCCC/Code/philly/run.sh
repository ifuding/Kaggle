...
python3 PoolGRU.py --input-training-data-path ../../Data/ --output-model-path . --model_type cnn \
        --max_seq_len 2048 --nfold 10 --emb_dim 128 --epochs 2 --batch_size 256 --ensemble_nfold 2 \
        ...
        --wv_model_file wiki.en.vec -resnet_hn False --vdcc_top_k 1 --char_split True --load_wv_model False \
        --fix_wv_model False --letter_num 4
